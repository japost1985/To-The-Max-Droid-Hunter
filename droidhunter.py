...
"""
╔══════════════════════════════════════════════════════════════════╗
║          To The Max Droid Hunter — Android Pentesting Tool       ║
║          Author : Japost1985                                     ║
║          Contact: tothemax.kali.jaa@proton.me                    ║
...
VERSION     = "2.0.0"
AUTHOR      = "Japost1985"
INSTAGRAM   = "tothemax.kali.jaa@proton.me"
TOOL_NAME   = "To The Max Droid Hunter"
YEAR        = "2026"
...
def print_banner():
    """Print the animated To The Max Droid Hunter banner with live status."""
...
MENU_OPTIONS = [
    ...
    ("17", "❔", "About",                   "About To The Max Droid Hunter"),
    ("0",  "🚪", "Exit",                    "Exit To The Max Droid Hunter"),
]
...
def handle_about():
    about = Panel(
        ...
        title="[bold]About To The Max Droid Hunter[/]",
        border_style="magenta",
        padding=(0, 4),
    )
    console.print(about)
...
def interactive_mode():
    ...
    console.print(Panel(
        ...
        "[white]To The Max Droid Hunter is designed for authorized security testing ONLY.\n"
    ...
    while True:
        ...
        choice = Prompt.ask("\n[bold cyan]To The Max Droid Hunter ▶[/]", choices=valid_choices, show_choices=False)

        if choice == "0":
            console.print("\n[bold magenta]👻 Exiting To The Max Droid Hunter. Stay ethical.[/]\n")
            sys.exit(0)
...
if __name__ == "__main__":
    try:
        ...
        console.print("\n\n[bold magenta]👻 To The Max Droid Hunter interrupted. Stay ethical.[/]\n")
        sys.exit(0)